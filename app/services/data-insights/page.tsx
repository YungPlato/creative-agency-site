  ...
  return (
    <main>
      ...
      <section className="container mx-auto px-6 py-32 scroll-mt-28">
        <Reveal>
          <h1 className="text-4xl md:text-6xl font-bold text-center mb-4">Data & Insights</h1>
          <p className="text-center text-gray-400 mb-12">
            Detailed information about our Data & Insights services. We help you turn data into actionable insights for growth.
          </p>
        </Reveal>
