  ...
  return (
    <main>
      ...
      <section className="container mx-auto px-6 py-32 scroll-mt-28">
        <Reveal>
          <h1 className="text-4xl md:text-6xl font-bold text-center mb-4">Marketing Automation</h1>
          <p className="text-center text-gray-400 mb-12">
            Detailed information about our Marketing Automation services. We help you automate your marketing to save time and scale.
          </p>
        </Reveal>
